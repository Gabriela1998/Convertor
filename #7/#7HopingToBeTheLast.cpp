...
din_nou:
    ...
    print( metruInUnitate(unitateInMetru(nrTransformare, nrUnitateDin), nrUnitateIn), 20 );
    cout<<lungimeIn<<"\n\n";
...
din_nou:
    ...
    if(nrUnitateIn==8) return 0;
    citesteNrValid(nrTransformare);
    cout<<"\nConversia ceruta este : "<<fixed<<nrTransformare;
    cout<<arieDin<<"  =  ";
    //printf ("%.20g", metruPInUnitate(unitateInMetruP(nrTransformare, nrUnitateDin), nrUnitateIn));
    print( metruPInUnitate(unitateInMetruP(nrTransformare, nrUnitateDin), nrUnitateIn), 20 );
    cout<<arieIn<<"\n\n";
    cout<<"Apasati enter pentru a alege o alta optiune. ";
    cin.get();
    cin.get();
...
din_nou:
    ...
    cout<<"\nConversia ceruta este : "<<fixed<<nrTransformare;
    cout<<timpDin<<"  =  ";
    printf ("%.10g", ziInUnitate(unitateInZi(nrTransformare, nrUnitateDin), nrUnitateIn));
    cout<<timpIn<<"\n\n";
    cout<<"Apasati enter pentru a alege o alta optiune. ";
    cin.get();
    cin.get();
...
int alegeVitezaIn(string &vitezaIn)
{
    ...
    string vecUnitati[8]={" m/s "," km/h "," m/h "," knots "," mi/h "};
...
din_nou:
    ...
    cout<<"\nConversia ceruta este : "<<fixed<<nrTransformare;
    cout<<vitezaDin<<"  =  ";
    printf ("%.10g", mpsInUnitate(unitateInMps(nrTransformare, nrUnitateDin), nrUnitateIn));
    cout<<vitezaIn<<"\n\n";
    cout<<"Apasati enter pentru a alege o alta optiune. ";
    cin.get();
    cin.get();
...
din_nou:
    ...
    cout<<"\nConversia ceruta este : "<<fixed<<nrTransformare;
    cout<<tempDin<<"  =  ";
    printf ("%.20g", gradeCInUnitate(unitateInGradeC(nrTransformare, nrUnitateDin), nrUnitateIn));
    cout<<tempIn<<"\n\n";
    cout<<"Apasati enter pentru a alege o alta optiune. ";
    cin.get();
    cin.get();
...
int alegeMasaIn(string &masaIn)
{
    ...
    string vecUnitati[8]={" kg "," g "," q "," lb "," oz "," ct "};
...
din_nou:
    ...
    cout<<"\nConversia ceruta este : "<<fixed<<nrTransformare;
    cout<<masaDin<<"  =  ";
    printf ("%.10g", kgInUnitate(unitateInKg(nrTransformare, nrUnitateDin), nrUnitateIn));
    cout<<masaIn<<"\n\n";
    cout<<"Apasati enter pentru a alege o alta optiune. ";
    cin.get();
    cin.get();
...
din_nou:
    ...
    cout<<"\nConversia ceruta este : "<<fixed<<nrTransformare;
    cout<<energieDin<<"  =  ";
    printf ("%.10g", JInUnitate(unitateInJ(nrTransformare, nrUnitateDin), nrUnitateIn));
    cout<<energieIn<<"\n\n";
    cout<<"Apasati enter pentru a alege o alta optiune. ";
    cin.get();
    cin.get();
...
din_nou:
    ...
    cout<<"\nConversia ceruta este : "<<fixed<<nrTransformare;
    cout<<presiuneDin<<"  =  ";
    printf ("%.10g", paInUnitate(unitateInPa(nrTransformare, nrUnitateDin), nrUnitateIn));
    cout<<presiuneIn<<"\n\n";
    cout<<"Apasati enter pentru a alege o alta optiune. ";
    cin.get();
    cin.get();
...
int alegeDensIn(string &densIn)
{
    ...
    string vecUnitati[8]={" kg/m^3 "," kg/l "," g/m^3 "," mg/m^3 "," oz/yd^3 "};
...
din_nou:
    ...
    cout<<"\nConversia ceruta este : "<<fixed<<nrTransformare;
    cout<<densDin<<"  =  ";
    printf ("%.10g", DInUnitate(unitateInD(nrTransformare, nrUnitateDin), nrUnitateIn));
    cout<<densIn<<"\n\n";
    cout<<"Apasati enter pentru a alege o alta optiune. ";
    cin.get();
    cin.get();
...
din_nou:
    ...
    cout<<"\nConversia ceruta este : "<<fixed<<nrTransformare;
    cout<<consDin<<"  =  ";
    printf ("%.20g", consInUnitate(unitateInCons(nrTransformare, nrUnitateDin), nrUnitateIn));
    cout<<consIn<<"\n\n";
    cout<<"Apasati enter pentru a alege o alta optiune. ";
    cin.get();
    cin.get();
